...
public class ArticleAdapter extends RecyclerView.Adapter<ArticleAdapter.ArticleViewHolder> {
    ...
    public ArticleViewHolder onCreateViewHolder(ViewGroup parent, int position) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_item_two, parent, false);
    ...
    public void onBindViewHolder(final ArticleViewHolder articleViewHolder, final int position) {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(context,R.layout.list_view_items, R.id.text_id,article.requirements);
        articleViewHolder.requirements.setAdapter(arrayAdapter);
       // articleViewHolder.textContent.setText(article.text);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try{
        articleViewHolder.sources.setText(article.source);
        articleViewHolder.textTitle.setText(article.title);
        articleViewHolder.benefits.setText(article.benefits);
    ...
    public static class ArticleViewHolder extends RecyclerView.ViewHolder implements AwesomeViewHolder {
        ...
        TextView benefits;
        TextView sources;
        NonScrollListView requirements;;
        TextView textTitle;
        View readMore;
        View readMoreAction;
        ...
        ArticleViewHolder(View itemView) {
            ...
            benefits = (TextView) itemView.findViewById(R.id.fourth_content);
            sources = (TextView) itemView.findViewById(R.id.second_content);
            requirements = (NonScrollListView) itemView.findViewById(R.id.text_list);
