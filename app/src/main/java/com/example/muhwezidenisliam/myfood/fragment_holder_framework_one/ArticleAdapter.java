...
public class ArticleAdapter extends RecyclerView.Adapter<ArticleAdapter.ArticleViewHolder> {
    ...
    public ArticleViewHolder onCreateViewHolder(ViewGroup parent, int position) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_item_one, parent, false);
    ...
    public void onBindViewHolder(final ArticleViewHolder articleViewHolder, final int position) {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(context,R.layout.list_view_items, R.id.text_id,article.text);

        articleViewHolder.text_list.setAdapter(arrayAdapter);
    ...
    public static class ArticleViewHolder extends RecyclerView.ViewHolder implements AwesomeViewHolder {
        ...
        ArticleViewHolder(View itemView) {
            ...
            text_list = (NonScrollListView) itemView.findViewById(R.id.text_list);
